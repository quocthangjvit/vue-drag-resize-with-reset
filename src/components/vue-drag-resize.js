...
export default {
    name: 'vue-drag-resize-with-reset',
    props: {
        stickSize: {
    ...
    mounted: function () {
        ...
        this.defaultWidth = this.defaultw;
        this.defaultHeight = this.defaulth;
    ...
    methods: {
        ...
        calcDragLimitation() {
            ...
            return {
                minLeft: 0,
                maxLeft: parentWidth - this.defaultWidth,
                minRight: 0,
                maxRight: parentWidth - this.defaultWidth,
                minTop: 0,
                maxTop: parentHeight - this.defaultHeight,
                minBottom: 0,
                maxBottom: parentHeight - this.defaultHeight
            }
        },
